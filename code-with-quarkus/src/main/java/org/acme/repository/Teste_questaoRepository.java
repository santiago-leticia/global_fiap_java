...
/*
T_RHSTU_TESTE_QUESTAO(
id_questao NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
tx_questao VARCHAR(90)
)
*/
@ApplicationScoped
public class Teste_questaoRepository {
    ...
    public void inserirQuestao(Teste_QuestaoDTO testeQuestaoDTO){
        String sql="INSERT INTO T_RHSTU_TESTE_QUESTAO(tx_questao) VALUES (?)";
