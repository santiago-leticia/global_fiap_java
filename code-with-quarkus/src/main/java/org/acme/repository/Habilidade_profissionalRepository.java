...
nv_habilidade_profissional CHAR(30) check(nv_habilidade_profissional='basico' OR nv_habilidade_profissional='intemidiario' OR nv_habilidade_profissional='avançando') NOT NULL,
nv_importancia CHAR(30) check(nv_importancia='baixa' OR nv_importancia='media' OR nv_importancia='alta') NOT NULL,
