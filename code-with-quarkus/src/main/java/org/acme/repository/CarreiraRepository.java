...
public class CarreiraRepository {
    /*
        ...
        id_carreira INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
        nm_carreira VARCHAR(80) NOT NULL,
        anos_formacao NUMBER not null,
        nm_area_de_trabalho VARCHAR(120) NOT NULL,
        in_trabalho VARCHAR(250) NOT NULL,
        dica_treino VARCHAR(250) NOT NULL,
        salario_min NUMBER NOT NULL,
        salario_max NUMBER NOT NULL,
        tempo_preparo_meses NUMBER NOT NULL
);
    ...
    */
    ...
    public void  inserirCarreira(CarreiraDTO c) throws SQLException{
        ...
        try (Connection con= dataSource.getConnection();
            ...
            ps.setDouble(6,c.getSalario_min());
            ps.setDouble(7,c.getSalario_max());
            ps.setInt(8,c.getTempo_preparo_meses());
        ...
        PreparedStatement ps= con.prepareStatement(sql)){
            ...
            try(ResultSet rs=ps.executeQuery()){
                while(rs.next()){
                    ...
                    carreira.setSalario_min(rs.getDouble(7));
                    carreira.setSalario_max(rs.getDouble(8));
                    carreira.setTempo_preparo_meses(rs.getInt(9));
