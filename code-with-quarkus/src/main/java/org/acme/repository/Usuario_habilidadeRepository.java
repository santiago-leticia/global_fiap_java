...
public class Usuario_habilidadeRepository {
    ...
    id_habilidade_usuario INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    id_usuario INTEGER NOT NULL,
    id_habilidade INTEGER NOT NULL,
    lv_proficiencia CHAR(30) check(lv_proficiencia='basico' OR lv_proficiencia='intemidiario' OR lv_proficiencia='avançando') not null,
    CONSTRAINT FK_T_RHSTU_HABILIDADE FOREIGN KEY(id_habilidade) REFERENCES T_RHSTU_HABILIDADE,
    CONSTRAINT T_RHSTU_USUARIO_FK FOREIGN KEY(id_usuario) REFERENCES T_RHSTU_USUARIO
)*/
    @Inject
