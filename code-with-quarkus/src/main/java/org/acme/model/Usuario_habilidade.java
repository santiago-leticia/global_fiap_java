...
public class Usuario_habilidade {
    private int id_habilidade_usuario;
    private int id_usuario;
    private int id_habilidade;
    private String lv_proficiencia;

    public Usuario_habilidade() {
    }

    public int getId_habilidade_usuario() {
        return id_habilidade_usuario;
    }

    public void setId_habilidade_usuario(int id_habilidade_usuario) {
        this.id_habilidade_usuario = id_habilidade_usuario;
    }
